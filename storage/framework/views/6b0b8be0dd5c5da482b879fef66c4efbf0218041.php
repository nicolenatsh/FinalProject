...
<!-- breadcrumb -->
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Edit Profil</a>
      </div>
    </li>
    </ol>
    </nav>
...
<div class="container">
        <div class="col-md-12 mt-2">
            ...
            <form method="POST" action="<?php echo e(url('edit-profile')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="nohp"  required autocomplete="nohp" autofocus>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\FinalProject\resources\views/edit-profile.blade.php ENDPATH**/ ?>